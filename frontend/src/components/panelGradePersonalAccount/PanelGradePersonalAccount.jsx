				...
				<div className={`${styles['setting_block__panel']} ${styles['setting_block__panel_mod7']}`}>
					...
					<div className={styles.setting_block__panel_score}>
						<div className={`${styles['setting_block__block_lesson']} ${styles['setting_block__block_lesson_small']}`}>
							...
							<span className={`${styles['setting_block__average_score']} ${styles['setting_block__average_score_yellow']}`}>3.5</span>
							<span className={`${styles['setting_block__percentage_visits']} ${styles['setting_block__percentage_visits_yellow']}`}>65%</span>
						</div>
